...
<!-- ============ SİCİL İŞLEM TAKİBİ (todo) ============ -->
<?php if (! empty($sicilBildirim) && ((int) $sicilBildirim['bekleyen'] > 0 || (int) $sicilBildirim['gecikti'] > 0)): ?>
<div class="kart">
  <div class="kart-baslik">
    <h2>🧾 Sicil İşlem Takibi</h2>
    <div class="sag"><a href="<?= site_url('sicil') ?>" class="btn ikincil mini">İşlemler →</a></div>
  </div>
  <div class="kart-govde">
    <div class="stat-grid">
      ...
      <a class="stat mavi" style="text-decoration:none;color:inherit" href="<?= site_url('sicil?aralik=ic15') ?>">
