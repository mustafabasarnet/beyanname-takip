...
```
 ...
 − Diğer mahsuplar
 + Yıl içinde ödenen KDV        ← KDV tablosundan (aşağıya bakın)
 ─────────────────────────
 = Net Mahsup
 ─────────────────────────
...
| **KDV: Ödenen** | yıl içinde vergi dairesine ödenen KDV |
| **YIL İÇİ VERGİ YÜKÜ** | ikisinin toplamı — ödenecek ya da iade |

**Örnek:** Gelir vergisi 3.000 ₺ çıktı, stopajdan 4.000 ₺ alacağınız var →
**1.000 ₺ devletten alacaklısınız**. KDV tablosunda 2.500 ₺ ödeme görünüyor →
`−1.000 + 2.500 = ` **1.500 ₺ vergi yükü (ödeyeceksiniz)**.

Stopaj alacağınız KDV'den büyükse satır yeşile döner ve *İADE ALACAKSINIZ* yazar.
...
|---|---|---|
| Bağ-Kur / SGK primi | **Sınırsız** | — |
| Şahıs / hayat sigorta primi | Kârın **%15**'i | Kazanç (hasılat − gider) |
| Eğitim ve sağlık harcaması | Kârın **%10**'u | Kazanç (hasılat − gider) |
